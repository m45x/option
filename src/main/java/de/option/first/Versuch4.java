...
public class Versuch4 implements EWrapper {
	...
	private volatile String netLiquidationValue;
	...
	public void requestNetLiquidation() throws Exception {
		int reqId = 9001;
		clientSocket.reqAccountSummary(reqId, "All", "NetLiquidation");

		// Warte maximal 3 Sekunden auf Callback
		latch.await(3, TimeUnit.SECONDS);
		System.out.println("Anfrage ende " + getNetLiquidationValue());
	}
	...
	public void accountSummary(int reqId, String account, String tag, String value, String currency) {
		if ("NetLiquidation".equals(tag)) {
			...
			latch.countDown(); // Antwort empfangen
		}
	}
	...
	// andere EWrapper-Methoden leer lassen oder implementieren
}
